...
def main():
    ...
    while True:
        try:
            ...
            for currency in config.coin_ticker:
                currency_split = currency.split("-")[1]
                ...
                # 초기 자산 정리
                initial_avg_price = initial_asset_info['coin_info'][currency_split]['avg_price']
                initial_profit_rate = ((current_price - initial_avg_price) / initial_avg_price * 100) if initial_avg_price > 0 else 0
                initial_balance = initial_asset_info['coin_info'][currency_split]['balance']
            ...
            notifier.report_error(
                ...
                "시스템 상태": {
                    ...
                    "투자한도 조회": "성공" if limit_amounts_per_coin else "실패"
                }
                }
            )
